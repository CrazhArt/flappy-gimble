...
In the future, I would like to make it so the stalagmites and stalactites also scroll progressively slower the further out the background is. I would also like to reproduce this same game on a proper game engine, as well as even trying to recreate the simple game concept in other languages, such as C# or C++. From here marks my start as a video game developer.